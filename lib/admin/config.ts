    ...
    fields: [
      ...
      { name: "title", label: "Title", type: "text", required: true },
      {
        ...
        options: [
          ...
          { value: "gold", label: "Gold (Reception)" },
      ...
      {
        name: "map_url",
        label: "Venue map link (Google Maps URL)",
        type: "text",
        placeholder: "https://maps.google.com/…",
      },
      { name: "attire", label: "Dress Code", type: "text" },
      { name: "description", label: "Description", type: "textarea" },
      {
        name: "photo_path",
        label: "Card image (top-right corner)",
        type: "image",
        bucket: "gallery",
        aspect: 4 / 5,
      },
    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: "trad_men", label: "Extended Groomsmen" },
          { value: "maid_of_honour", label: "Maids of Honour" },
          { value: "bridesmaids", label: "Bridesmaids" },
          { value: "trad_ladies", label: "Extended Bridesmaids" },
        ],
      },
